...
InstallMainPackeges() {
    ...
    sudo pacman --noconfirm -S hyprland hyprpaper hyprshot waybar firefox neovim alacritty mc cmake smplayer btop numlockx udiskie pamixer feh zip unzip transmission-gtk ripgrep fzf nodejs npm
}
